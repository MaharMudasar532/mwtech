    ...
    <footer className="bg-gray-50 mt-8">
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-6">
        ...
        <div>
          ...
          <p className="text-gray-600">info@mwtech.example</p>
          <div className="mt-3 flex items-center gap-3 text-mw-primary">
            <a href="#" aria-label="LinkedIn" className="p-2 rounded-full bg-white shadow-card hover:bg-gray-100">
            ...
            <a href="#" aria-label="Facebook" className="p-2 rounded-full bg-white shadow-card hover:bg-gray-100">
            ...
            <a href="#" aria-label="Instagram" className="p-2 rounded-full bg-white shadow-card hover:bg-gray-100">
